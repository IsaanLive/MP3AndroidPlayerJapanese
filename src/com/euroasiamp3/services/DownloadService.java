...
import com.euroasia.jp.DownloadingActivity;
import com.euroasia.jp.R;
...
public class DownloadService extends Service {
	...
	public class DownloadFilesTask  extends AsyncTask<String, Void, Void> {
		...
		protected void onCancelled() {
			...
			regularNotif("ダウンロードをキャンセルしました","キャンセルしました: "+filename,filename); 
		...
		protected void onPostExecute(Void result) {
			...
			if(fail == 1){
				regularNotif("ダウンロード失敗しました","失敗しました: "+filename,filename); 
				http--;
				...
				regularNotif("ダウンロード完了しました","完了しました: "+filename,filename); 
			}
		...
		public void ongoingNotif(String contentTitle, String tickerText, String contentText ){
			...
			notification.setLatestEventInfo(context, contentTitle, "経過を見るにはここをクリックして下さい", contentIntent);
			notificationManager.notify(numberd+9, notification);
		}
